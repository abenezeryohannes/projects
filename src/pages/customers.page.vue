<template>
    ...
    <section class="page">
        ...
        <div class="relative mb-16">
            ...
            <customers-table :view="view" :response="response" :list="list" :clickable="true" :loading="loading_table"
...
import customersTable from './tables/customers.table.vue';
...
function onItemClick(event: any) {
    ...
    router.push({ name: 'customer', params: { id: list.value[event.index].id } });
}
...
async function load() {
    ...
    try {
        var res = await new RequestHandler().get('users/findAllCustomers',
            {
                search: search.value,
                sort: sort.value,
