<template>
  <section
    class="relative md:mb-10 md:mt-0 mb-2 px-5 py-7 shadow-md rounded-xl"
    :style="{ backgroundColor: '#007868' }"
  >
...
async function load() {
  ...
  try {
    const res = (
      await new RequestHandler().get("analytics/total_online_users", {})
