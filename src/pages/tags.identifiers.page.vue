...
import tagsIdentifierTable from "./tables/tags.identifier.table.vue";
...
import TagIdentifier from "./details/tag.identifier.page.vue";
...
let view = ref<string | null>(localStorage.getItem("view_type_tag_identifier"));
const router = useRouter();

watch(
  () => view.value,
  (val, _) => {
    if (val != null) localStorage.setItem("view_type_tag_identifier", val!);
  }
);
