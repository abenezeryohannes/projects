...
const headers = ref<any[]>([
    ...
    // {label:'Email Address', name:'emailAddress', width:'3', sortable:false, type:"text", cls: 'justify-start', editable: false}, 
    { label: 'Phone Number', name: 'phoneNumber', width: '3', sortable: true, type: "text", editable: true, cls: 'justify-start' },
    { label: 'enabled', name: 'enabled', width: '3', sortable: true, cls: 'justify-center text-center', type: "toggle", option: { positive: 'Yes', negative: 'No' }, },
