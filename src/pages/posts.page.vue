<template>
    ...
    <section class="page">
        ...
        <div class="relative mb-16">
            ...
            <posts-table :view="view" :response="response" :list="list" :clickable="false" :loading="loading_table"
...
import postsTable from './tables/posts.table.vue';
...
async function load() {
    ...
    try {
        var res = await new RequestHandler().get('posts',
            {
                search: search.value,
                sort: sort.value,
