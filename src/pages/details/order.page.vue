<template>
    <section class="relative page">
        ...
        <edit-fab class="fixed md:right-10 right-10 bottom-10 " :editing="editing" :errors="errors" :loading="loading"
...
async function load() {
    ...
    try {
        var res = await (new httpClient()).get('bookings/findOne',
            { id: route.params.id });
        ...
        response.value = null; error.value = e;
...
function edit() { editing.value = !editing.value; }
