...
class StaffActivityDatePicker extends StatefulWidget {
  const StaffActivityDatePicker(
  ...
  @override
  State<StaffActivityDatePicker> createState() =>
      _StaffActivityDatePickerState();
}

class _StaffActivityDatePickerState extends State<StaffActivityDatePicker> {
  late DateTime temp;
  @override
  void initState() {
    temp = widget.date;
